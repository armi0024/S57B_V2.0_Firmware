...
volatile uint8_t enabled2=1;
//#pragma GCC push_options
//#pragma GCC optimize ("-Ofast")

uint32_t lastStepMicros; // time in microseconds that last step happened
uint8_t forwardRotation=1;

//uint32_t microsSinceStep(void)
//{
//    return micros()-lastStepMicros;
//}
void setRotationDirection(uint8_t forward) 
{
    forwardRotation=forward;
}
   
#define DAC_MAX (0x01FF)
...
//void limitCurrent(uint8_t percent)
//{
//#ifdef MECHADUINO_HARDWARE
//	return;
//#else
