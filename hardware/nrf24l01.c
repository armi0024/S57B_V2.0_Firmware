...
const u8 TX_ADDRESS_P0[TX_ADR_WIDTH]={0x34,0x43,0x10,0x10,0x01}; //发送地址
const u8 RX_ADDRESS_P0[RX_ADR_WIDTH]={0x34,0x43,0x10,0x10,0x01}; //发送地址
	
//const u8 TX_ADDRESS_P1[TX_ADR_WIDTH]={0xb3,0xb4,0xb5,0xb6,0x02}; //发送地址
//const u8 RX_ADDRESS_P1[RX_ADR_WIDTH]={0xb3,0xb4,0xb5,0xb6,0x02}; //发送地址
...
void NRF24L01_Init(void)
{
	...
	GPIOA->CRL&=0XFFF0FFFF;//PA4输出 CE
	GPIOA->CRL|=0X00030000; 
	GPIOA->ODR|=1<<4;	   //PA4 输出1	
	GPIOA->CRH&=0XFFFFFFF0;//PA8输出
	GPIOA->CRH|=0X00000003; 
	GPIOA->ODR|=1<<8;	   //PA8 输出1		
	GPIOB->CRL&=0XFF0FFFFF;//PB5输入
...
{
	NRF24L01_CE=0;	  
  	NRF24L01_Write_Buf(W_REGISTER+RX_ADDR_P0,(u8*)RX_ADDRESS_P0,RX_ADR_WIDTH);//写RX节点地址
  	...
  	NRF24L01_Write_Reg(W_REGISTER+RX_PW_P0,RX_PLOAD_WIDTH);//选择通道0的有效数据宽度 	    
...
{														 
	NRF24L01_CE=0;	    
  	NRF24L01_Write_Buf(W_REGISTER+TX_ADDR,(u8*)TX_ADDRESS_P0,TX_ADR_WIDTH);//写TX节点地址 
  	NRF24L01_Write_Buf(W_REGISTER+RX_ADDR_P0,(u8*)RX_ADDRESS_P0,RX_ADR_WIDTH); //设置TX节点地址,主要为了使能ACK	  
